	...
	<footer class="entry-meta">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			<?php
				...
				$categories_list = get_the_category_list( __( ', ', 'outlines' ) );
				if ( $categories_list && outlines_categorized_blog() ) :
			?>
			<span class="cat-links">
				<?php printf( __( 'Posted in %1$s', 'outlines' ), $categories_list ); ?>
			</span>
		...
		<span class="sep"> | </span>
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'outlines' ), __( '1 Comment', 'outlines' ), __( '% Comments', 'outlines' ) ); ?></span>
		<?php endif; ?>
